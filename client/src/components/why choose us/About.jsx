...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="py-16 lg:py-24 bg-gradient-to-br from-white via-primary-25 to-primary-50 relative overflow-hidden [content-visibility:auto] [contain-intrinsic-size:1px_1000px]"
    >
