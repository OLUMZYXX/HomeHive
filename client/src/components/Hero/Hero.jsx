...
const Hero = () => {
  ...
  return (
    <section className="relative w-full h-[78vh] min-h-[540px] sm:h-[80vh] sm:min-h-[560px] lg:h-screen lg:min-h-[600px] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6 pt-24 sm:pt-20 lg:pt-0 pb-28 sm:pb-24 lg:pb-0">
        {/* Stars */}
        ...
        <h1
          className="font-Cormorant text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-light text-white leading-[1.05] tracking-wide mb-3 sm:mb-4"
        ...
        {/* Subtitle */}
        <p className="font-NotoSans text-white/75 text-sm sm:text-lg max-w-xl mt-2 sm:mt-4 mb-6 sm:mb-10 font-light leading-relaxed">
        ...
        <button
          ...
          className="group inline-flex items-center gap-3 text-white/90 hover:text-white border border-white/50 hover:border-white px-8 sm:px-10 py-3.5 sm:py-4 text-xs sm:text-sm font-medium tracking-[0.25em] uppercase transition-all duration-300 hover:bg-white/10 backdrop-blur-sm"
        >
          Explore
      ...
      <div className="absolute bottom-0 left-0 right-0 z-10 flex items-stretch">
        {/* Since tag */}
        <div className="flex items-center gap-3 sm:gap-4 bg-white px-4 sm:px-8 py-3 sm:py-4 flex-1 sm:flex-none">
          <div>
            <div className="text-[10px] sm:text-xs font-semibold text-neutral-400 tracking-widest uppercase">Since</div>
            <div className="text-xl sm:text-2xl font-bold text-neutral-800 leading-none font-Cormorant">2020</div>
          </div>
          <div className="w-px h-8 sm:h-10 bg-neutral-200" />
          <div className="text-[10px] sm:text-xs text-neutral-500 tracking-wider uppercase font-medium leading-tight">
            Nigeria's<br />Trusted Platform
          </div>
        </div>
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 sm:gap-3 bg-amber-500 hover:bg-amber-600 text-white px-4 sm:px-7 py-3 sm:py-4 text-[10px] sm:text-xs font-semibold tracking-widest uppercase transition-colors duration-200 whitespace-nowrap"
        >
          Our Story
