...
export class TokenManager {
  static ACCESS_TOKEN_KEY = "homehive_user_access_token";
  static REFRESH_TOKEN_KEY = "homehive_user_refresh_token";
...
// Host-specific token manager
export class HostTokenManager {
  static ACCESS_TOKEN_KEY = "homehive_host_access_token";
  static REFRESH_TOKEN_KEY = "homehive_host_refresh_token";
  static USER_DATA_KEY = "homehive_host_data";
